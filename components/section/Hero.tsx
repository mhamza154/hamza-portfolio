      ...
      >
        ...
        >
          <div className="w-60 md:w-72 backdrop-blur-xl bg-white/70 dark:bg-black/70 border shadow-xl rounded-2xl p-6">
            <p className="text-[10px] tracking-widest mb-4">
              TELEMETRY / ACTIVE
            </p>
        ...
        >
          <div className="w-60 md:w-80 backdrop-blur-xl bg-white/70 dark:bg-black/70 border shadow-xl rounded-2xl p-6">
            <p className="text-[10px] tracking-widest mb-6">
              TECH SPECS / LOAD
            </p>
            <div className="mb-4">
        ...
        <div ref={containerRef} className="overflow-hidden w-full">
          <h2
            ref={marqueeRef}
            className="text-[6rem] sm:text-[8rem] md:text-[10rem] xl:text-[12rem] hero-stroke-text whitespace-nowrap"
          >
